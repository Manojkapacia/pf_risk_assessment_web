export const getReportSubmissionMessage = () => {
    ...
    if (isBetween(19, 0, 23, 59)) {
        ...
        return "share your report by 12.00 noon tomorrow";
    } else if (isBetween(0, 1, 8, 59)) {
        // Between 12:01 AM and 9:00 AM
        return "share your report by 12.00 noon today";
    }

    return "share your report within 4 hours"; // Default case, if required
};
