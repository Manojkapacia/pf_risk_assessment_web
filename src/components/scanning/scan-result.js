...
const ScanResult = (props) => {
    ...
    return (
        ...
        <h2 className="fw-boldHeading">Dates Mismatch</h2>
        ...
        <div className="row g-3 mt-3 mb-3">
            ...
            <div className="py-3 px-2 border rounded bg-light scanResCol">
                ...
                <span className="fw-boldHeading">Date of Exit</span>
                <span className="text-danger">-Failed</span>
                </div>
                <span className="badge bg-danger text-uppercase">Critical</span>
                <p className="text-muted">Date of exit not marked for <strong>Tata Consultancy Services LTD.</strong></p>
            </div>
            </div>
            ...
            <div className="py-3 px-2 border rounded bg-light scanResCol" >
                <div className="d-flex justify-content-between align-items-center">
                <span className="fw-boldHeading">Service Overlap</span>
                <span className="text-danger">- Failed</span>
                </div>
                <span className="badge bg-danger text-uppercase">Critical</span>
                <p className="text-muted">Service overlap found between <strong>Tata Consultancy Services LTD</strong> and <strong>Accenture</strong></p>
            </div>
            </div>
        </div>
        </div>
